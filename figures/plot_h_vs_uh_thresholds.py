...
def plot_h_and_uh_thresholds(in_files, styles, title, out_file):
    """
        Plots heralded and unheralded SPF teleportation lattice channel rates
        for given sizes.
    ...
    pf_labels = ['Heralded', 'Unheralded']
    size_labels = [h.get_label() for h in size_handles]
    size_lgd = plt.legend(size_handles, size_labels,
                          loc='upper right', fontsize=24, framealpha=1)
    pf_lgd = plt.legend(pf_handles, pf_labels,
                        loc=(0.532, 0.45), fontsize=24, framealpha=1)
    ax.add_artist(pf_lgd)
    ax.add_artist(size_lgd)
...
if __name__ == '__main__':
    # ============== PLOTS CHANNEL THRESHOLDS (UH and H) =================
    ...
    in_files = \
        [['data/W4xL4_HexagonalLatticeChannel_MW5_10000MC_SPF_TEL_RATE.csv',
         ...
         ['data/W3xL3_HexagonalLatticeChannel_MW5_10000MC_SPF_TEL_RATE.csv',
          'data/W3xL3_HexagonalLatticeChannel_MW5_10000MC_SPF_UH_MT_TEL_RATE.csv'],
         ['data/W2xL2_HexagonalLatticeChannel_MW5_10000MC_SPF_TEL_RATE.csv',
          'data/W2xL2_HexagonalLatticeChannel_MW5_10000MC_SPF_UH_MT_TEL_RATE.csv']]
    styles = [{'color': 'b', 'line': '-', 'label': '$4 \\times 4$'},
              {'color': 'r', 'line': '-', 'label': '$3 \\times 3$'},
              {'color': 'g', 'line': '-', 'label': '$2 \\times 2$'}]
    out_file = 'pngs/hex_H-UH_MT_thresholds.png'
    title = 'Hexagonal Lattice'
    plot_h_and_uh_thresholds(in_files, styles, title, out_file)
    ...
    in_files = \
        [['data/W4xL4_SquareLatticeChannel_MW5_10000MC_SPF_TEL_RATE.csv',
         ...
         ['data/W3xL3_SquareLatticeChannel_MW5_10000MC_SPF_TEL_RATE.csv',
          'data/W3xL3_SquareLatticeChannel_MW5_10000MC_SPF_UH_MT_TEL_RATE.csv'],
         ['data/W2xL2_SquareLatticeChannel_MW5_10000MC_SPF_TEL_RATE.csv',
          'data/W2xL2_SquareLatticeChannel_MW5_10000MC_SPF_UH_MT_TEL_RATE.csv']]
    styles = [{'color': 'b', 'line': '-', 'label': '$4 \\times 4$'},
              {'color': 'r', 'line': '-', 'label': '$3 \\times 3$'},
              {'color': 'g', 'line': '-', 'label': '$2 \\times 2$'}]
    out_file = 'pngs/square_H-UH_MT_thresholds.png'
    ...
    in_files = \
        [['data/W4xL4_TriangularLatticeChannel_MW5_10000MC_SPF_TEL_RATE.csv',
         ...
         ['data/W3xL3_TriangularLatticeChannel_MW5_10000MC_SPF_TEL_RATE.csv',
          'data/W3xL3_TriangularLatticeChannel_MW5_10000MC_SPF_UH_MT_TEL_RATE.csv'],
         ['data/W2xL2_TriangularLatticeChannel_MW5_10000MC_SPF_TEL_RATE.csv',
          'data/W2xL2_TriangularLatticeChannel_MW5_10000MC_SPF_UH_MT_TEL_RATE.csv']]
    styles = [{'color': 'b', 'line': '-', 'label': '$4 \\times 4$'},
              {'color': 'r', 'line': '-', 'label': '$3 \\times 3$'},
              {'color': 'g', 'line': '-', 'label': '$2 \\times 2$'}]
    out_file = 'pngs/tri_H-UH_MT_thresholds.png'
